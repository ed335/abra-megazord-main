            ...
            <Accordion.Header>
              <Accordion.Trigger className="flex w-full items-center justify-start gap-x-4">
                <div
                  className={cn(
                    ...
                    openItem === item.id.toString() 
                      ? "bg-[#3FA174]/20 text-[#3FA174]" 
                      : "bg-gray-100 hover:bg-[#3FA174]/10",
                    questionClassName
                  )}
                >
                  {item.icon && (
                ...
                <span 
                  className={cn(
                    "text-gray-400",
                    openItem === item.id.toString() && "text-[#3FA174]"
                  )}
                >
                  {openItem === item.id.toString() ? (
            ...
            <Accordion.Content asChild forceMount>
              ...
              >
                <div className="ml-7 mt-2 md:ml-16">
                  <div
                    className={cn(
                      "relative max-w-md rounded-2xl bg-[#3FA174] px-4 py-3 text-white",
                      answerClassName
                    )}
                  >
                    {item.answer}
